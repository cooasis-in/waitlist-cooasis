  ...
  return (
    <section className="bg-color">
      <div>
        ...
        <div className="mt-7 ">
          <img src="/images/avtars.svg" alt="People Join" className="h-10 mx-auto" />
          <span className="f-PowerGrotesk text-[14.5px] text-[#6A92985E] xxl:text-[17.5px] leading-[14.54px] flex justify-center items-center mt-2">+200 people joined</span>
        </div>
        <div className="mt-6 flex flex-col justify-center items-center space-x-4">
          <span className="f-PowerGrotesk text-[14.5px] xxl:text-[17.5px] leading-[14.54px] text-[#6A9298] text-center mb-4">Backed by</span>
