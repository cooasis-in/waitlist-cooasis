...
const Refer = () => {
  ...
  return (
    <div className="bg-colorRefer bg-[#131515] min-h-screen flex flex-col items-center relative overflow-hidden">
      <ConfettiBackground />
      <div className="bg-[#0000000D] border-[1px] border-[#FFFFFF21] max-w-[400px] mt-10 rounded-[30px] p-10 pb-5 text-center shadow-lg relative z-10">
        ...
        <button
          type="submit"
          className="f-PowerGrotesk bg-[#0000006B] text-base btn-color text-[#FFF5D9] leading-tight font-normal px-6 py-4 w-full h-[55px] mt-8 rounded-full flex items-center dark:bg-[#000000] justify-center"
        >
          Refer a friend
        </button>
      </div>
      <div className="mt-8 flex flex-col items-center text-[#6A9298] space-y-4 max-w-[272px]">
